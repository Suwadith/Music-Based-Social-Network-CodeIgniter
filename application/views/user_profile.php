...
<form class="profile_form" action="<?php echo site_url('/SiteController/createProfile'); ?>" method="post">
    ...
    <div class="ui fluid multiple search selection dropdown">
        ...
        <div class="menu">
            <div class="item" data-value="electronic_dance">Electronic Dance</div>
            ...
            <div class="item" data-value="rhythm_blues">Rhythm & Blues</div>
            ...
            <div class="item" data-value="indie_rock">Indie Rock</div>
